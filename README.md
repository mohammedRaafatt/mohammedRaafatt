...
### 🟩 **Software Testing Intern — eTax Company**  
- **Reduced** post-release bugs by **30%** through deep manual + automated testing.  
- **Designed** a **PyTest regression suite** automating **60%** of test cases.  
- **Logged & resolved** **30+ critical defects**, improving release stability.  
- **Built** **compliance workflows** achieving **99% accuracy** in reporting.

---

## 📌 Featured Projects

### 🔹 **WinterCamp Reservation System**  
**Tech Stack:** ReactJS, TypeScript, HTML, CSS  
**Features:** Camp listings, special offers, testimonials, responsive UI  
🔗**Live:** https://winter-camp-reservation.netlify.app/

---

### 🔹 **Trendlia E-Commerce Landing Page**  
**Tech Stack:** ReactJS, TypeScript, HTML, CSS  
**Features:** Categories, discounts, blog, social media integrations  
🔗**Live:** https://trendlia.netlify.app/

---

### 🔹 **ClinicHub Reservation System**  
**Tech Stack:** ReactJS, TypeScript, HTML, CSS  
**Features:** Search doctors, view availability, instant booking  
🔗**Live:** https://clinic-hub-booking.netlify.app/

---

### 🔹 **DreamHomes Landing Page**  
**Tech Stack:** HTML, CSS, JavaScript, Bootstrap  
**Features:** Properties, agent profiles, inquiry system, mortgage calculator, chatbot  
🔗**Live:** https://dreamh0mes.netlify.app/
